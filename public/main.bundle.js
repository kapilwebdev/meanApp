...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__component_profile_profile_component__ = __webpack_require__("../../../../../src/app/component/profile/profile.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__component_dashboard_dashboard_component__ = __webpack_require__("../../../../../src/app/component/dashboard/dashboard.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__component_login_login_component__ = __webpack_require__("../../../../../src/app/component/login/login.component.ts");
...
var routes = [
    ...
    { path: 'dashboard', component: __WEBPACK_IMPORTED_MODULE_10__component_dashboard_dashboard_component__["a" /* DashboardComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_15__guard_auth_guard__["a" /* AuthGuard */]] },
    { path: 'register', component: __WEBPACK_IMPORTED_MODULE_8__component_register_register_component__["a" /* RegisterComponent */] },
    { path: 'profile', component: __WEBPACK_IMPORTED_MODULE_7__component_profile_profile_component__["a" /* ProfileComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_15__guard_auth_guard__["a" /* AuthGuard */]] },
    { path: 'login', component: __WEBPACK_IMPORTED_MODULE_14__component_login_login_component__["a" /* LoginComponent */] }
];
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_7__component_profile_profile_component__["a" /* ProfileComponent */],
            ...
            __WEBPACK_IMPORTED_MODULE_10__component_dashboard_dashboard_component__["a" /* DashboardComponent */],
            __WEBPACK_IMPORTED_MODULE_14__component_login_login_component__["a" /* LoginComponent */]
        ],
        imports: [
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_11__services_validate_service__["a" /* ValidateService */], __WEBPACK_IMPORTED_MODULE_12__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_15__guard_auth_guard__["a" /* AuthGuard */]],
...
var NavbarComponent = (function () {
    ...
    NavbarComponent.prototype.onLogoutClick = function () {
        ...
        this.flashMessages.show('You have logged out', { cssClass: 'alret-success', timeout: 3000 });
        this.router.navigate(['/']);
        return false;
    };
    NavbarComponent.prototype.show = function () { return this.authService.loggedIn(); };
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessage.show('You are now Registered', { cssClass: 'alert-success', timeout: 5000 });
                _this.router.navigate(['/login']);
            }
            else {
...
var AuthService = (function () {
    ...
    AuthService.prototype.passToken = function () {
